...
class MariaDbInstaller(object):
    ...
    def __init__(self, ssh_api):
        ...
        self.cmd_deb_frontend = "echo {0} | sudo -S export DEBIAN_FRONTEND = \"noninteractive\""
        ...
        self.cmd_create_db = "echo {0} | sudo -S mysql -uroot -p{0} -e \'CREATE DATABASE liderdb DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci\'"
    ...
    def install(self, data):
        ...
        self.ssh_api.run_command(self.cmd_deb_frontend.format(data["password"]))
