...
from ejabberd_page import EjabberdPage
from db_page import DatabasePage
from ldap_page import OpenLDAPPage
...
class ConfigDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.pagesWidget.setMinimumHeight(512)
    ...
    def createIcons(self):
        ...
        configButton.setText("Bağlantı Ayarları")
